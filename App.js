        ...
        <View style={styles.notifyCard}>
          ...
          <View style={styles.notifyRow}>
            <TextInput
              ...
              onChangeText={(t) => {
                setNewsletterEmail(t);
                if (newsletterStatus !== 'idle') setNewsletterStatus('idle');
              }}
              editable={newsletterStatus !== 'sending'}
            />
            <TouchableOpacity
              style={[styles.notifyBtn, newsletterStatus === 'sending' && { opacity: 0.7 }]}
          ...
          {newsletterStatus === 'error' && (
            <Text style={styles.notifyErrorText}>تأكد من صحة البريد الإلكتروني وحاول مجدداً.</Text>
          )}
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  notifyBtn: { backgroundColor: COLORS.gold, borderRadius: 8, paddingVertical: 9, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center', minWidth: 70 },
