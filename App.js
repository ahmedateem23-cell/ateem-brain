...
const styles = StyleSheet.create({
  ...
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 22 },
  ...
  featuredCard: { width: CARD_W, marginBottom: 20, backgroundColor: THEME.card, borderRadius: 16, padding: 14 },
  featuredImageWrap: {
    width: '100%', height: CARD_W * 1.05, backgroundColor: THEME.background,
    marginBottom: 14, position: 'relative', borderRadius: 12, overflow: 'hidden',
  },
  featuredImage: { width: '100%', height: '100%' },
  featuredHeartBtn: {
    position: 'absolute', top: 10, left: 10, width: 32, height: 32, borderRadius: 16,
  ...
  featuredTitle: { fontFamily: THEME.fontBodySemiBold, fontSize: 16, color: THEME.textPrimary, marginBottom: 4 },
  featuredSubtitle: { fontFamily: THEME.fontBody, fontSize: 12, color: THEME.textSecondary, marginBottom: 10 },
  featuredPrice: { fontFamily: THEME.fontBodySemiBold, fontSize: 17, color: THEME.textPrice, marginBottom: 12 },
  featuredAddBtn: {
  ...
  // شريط المميزات — بار عنابي واحد بعرض الشاشة تقريباً، زي المرجع.
  featureBarWrap: { paddingHorizontal: 20, marginBottom: 6 },
  featureBar: {
    flexDirection: 'row-reverse',
    backgroundColor: COLORS.burgundy,
    borderRadius: 14,
  ...
  featureItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 6 },
  featureItemText: { fontFamily: THEME.fontBody, color: COLORS.white, fontSize: 11.5 },
  featureDivider: { width: 1, height: 30, backgroundColor: 'rgba(245,239,230,0.25)', alignSelf: 'center' },
