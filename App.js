    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.navbar}>
        <TouchableOpacity onPress={() => setMenuOpen(true)} style={styles.iconBtn}>
          <MenuIcon size={21} color={COLORS.gold} />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.iconBtn}>
          <CartIcon size={21} color={COLORS.gold} />
          {cartCount > 0 && (
...
const styles = StyleSheet.create({
  ...
  brand: { fontFamily: THEME.fontHeading, fontSize: 19, letterSpacing: 2.5, color: COLORS.gold },
  tagline: { fontFamily: THEME.fontBody, fontSize: 9, letterSpacing: 1.5, color: 'rgba(245,239,230,0.7)', marginTop: 3 },
  cartBadge: {
