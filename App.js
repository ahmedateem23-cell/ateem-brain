...
import {
  ...
  MenuIcon, CartIcon, SearchIcon, HomeIcon, HeartIcon, PlusIcon, ProfileIcon, GridIcon,
...
// شريط المميزات القصير (دعم متواصل / دفع آمن / توصيل سريع) — زي
// المرجع: شريط عنابي واحد تحت "منتجات مميزة"، بأيقونة وسطر نص لكل عنصر.
const FEATURE_ITEMS = [
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.featuredGrid, { gap: FEATURED_CARD_GAP }]}>
            {FEATURED_PRODUCTS.map((p) => (
              <View key={p.id} style={[styles.featuredCard, { width: FEATURED_CARD_W }]}>
                <View style={[styles.featuredImageWrap, { height: FEATURED_CARD_W * 0.82 }]}>
              ...
              <React.Fragment key={f.id}>
                <View style={styles.featureItem}>
                  <View style={styles.featureIconWrap}>
                    <f.Icon size={20} color={COLORS.burgundy} />
                  </View>
                ...
                <TouchableOpacity key={p.id} style={styles.productCard}>
                  <View style={styles.productImageWrap}>
                    ...
                    <TouchableOpacity style={styles.addToCartBtn}>
                      <PlusIcon size={14} color={COLORS.burgundy} />
                    </TouchableOpacity>
                  </View>
...
// بطاقات "منتجات مميزة" بس: فراغ أضيق بين البطاقتين (10 بدل 12) يوسّع
// كل بطاقة شوية تلقائيًا، وارتفاع صورة أقصر (factor أقل) يخلي البطاقة
// كلها أقصر — زي التصميم المرجعي (صورة 1).
const FEATURED_CARD_GAP = 10;
const FEATURED_CARD_W = (width - 24 * 2 - FEATURED_CARD_GAP) / 2;
...
const styles = StyleSheet.create({
  ...
  tagline: { fontFamily: THEME.fontBody, fontSize: 8, letterSpacing: 2, color: 'rgba(245,239,230,0.7)', marginTop: 2 },
  cartBadge: {
  ...
  hero: { paddingHorizontal: HERO_MARGIN, paddingBottom: 10 },
  ...
  sectionHeader: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 22 },
  ...
  sectionTitle: { fontFamily: THEME.fontHeading, fontSize: 29, color: THEME.textPrimary },
  sectionTitleSmall: { fontSize: 23 },
  sectionTitleUnderline: { width: 40, height: 3, borderRadius: 2, backgroundColor: COLORS.gold, marginTop: 8 },
  ...
  featuredCard: { width: CARD_W, marginBottom: 16, backgroundColor: THEME.card, borderRadius: 16, padding: 12 },
  featuredImageWrap: {
    width: '100%', height: CARD_W * 1.05, backgroundColor: THEME.background,
    marginBottom: 10, position: 'relative', borderRadius: 12, overflow: 'hidden',
  },
  ...
  featuredTitle: { fontFamily: THEME.fontBodySemiBold, fontSize: 15, color: THEME.textPrimary, marginBottom: 3 },
  featuredSubtitle: { fontFamily: THEME.fontBody, fontSize: 11.5, color: THEME.textSecondary, marginBottom: 8 },
  featuredPrice: { fontFamily: THEME.fontBodySemiBold, fontSize: 16, color: THEME.textPrice, marginBottom: 10 },
  featuredAddBtn: {
    flexDirection: 'row', gap: 6,
    backgroundColor: COLORS.gold, borderRadius: 8, paddingVertical: 11,
    alignItems: 'center', justifyContent: 'center',
  },
  featuredAddBtnText: { fontFamily: THEME.fontBodySemiBold, color: COLORS.burgundy, fontSize: 13.5 },

  // Products
  productsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: CARD_GAP, justifyContent: 'space-between' },
  productCard: { width: CARD_W, marginBottom: 20, backgroundColor: THEME.card, borderRadius: 14, padding: 10 },
  productImageWrap: { width: '100%', height: CARD_W * 1.2, backgroundColor: THEME.background, marginBottom: 10, position: 'relative', borderRadius: 10, overflow: 'hidden' },
  ...
  addToCartBtn: {
    position: 'absolute', bottom: 10, left: 10, width: 30, height: 30, borderRadius: 15,
  ...
  featureBarWrap: { paddingHorizontal: 20, marginTop: 4, marginBottom: 10 },
  featureBar: {
    flexDirection: 'row-reverse',
  ...
  featureItem: { flex: 1, alignItems: 'center', justifyContent: 'flex-start', gap: 8 },
  featureIconWrap: {
    width: 46, height: 46, borderRadius: 23,
    backgroundColor: 'rgba(107,30,46,0.08)',
    alignItems: 'center', justifyContent: 'center',
  },
  featureItemText: { fontFamily: THEME.fontBody, color: THEME.textPrimary, fontSize: 11.5, textAlign: 'center' },
  featureDivider: { width: 1, height: 34, backgroundColor: 'rgba(107,30,46,0.14)', alignSelf: 'center', marginTop: 6 },
