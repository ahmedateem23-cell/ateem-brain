...
import {
  ...
  MenuIcon, CartIcon, SearchIcon, HomeIcon, HeartIcon, PlusIcon,
} from './CategoryIcons';
...
const HERO_HEIGHT_FACTOR = 0.86;
const HERO_HEIGHT = (width / HERO_ASPECT_RATIO) * HERO_HEIGHT_FACTOR;
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.navbar}>
        <TouchableOpacity onPress={() => setMenuOpen(true)} style={styles.iconBtn}>
          <MenuIcon size={22} color={COLORS.charcoal} />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.iconBtn}>
          <CartIcon size={22} color={COLORS.charcoal} />
          {cartCount > 0 && (
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.bottomNavBtn}>
          <CartIcon size={20} color={THEME.textSecondary} />
...
const styles = StyleSheet.create({
  ...
  quickCatWrap: { paddingHorizontal: 20, marginTop: -16, marginBottom: 4 },
  quickCatCard: {
  ...
  quickCatLabel: { fontFamily: THEME.fontBody, fontSize: 11.5, color: THEME.textPrimary },
  quickCatDivider: { width: 1, height: 32, backgroundColor: THEME.border, alignSelf: 'center' },
  ...
  brand: { fontFamily: THEME.fontHeading, fontSize: 22, letterSpacing: 3, color: COLORS.burgundy },
  tagline: { fontFamily: THEME.fontBody, fontSize: 8, letterSpacing: 2, color: COLORS.gold, marginTop: 2 },
  cartBadge: {
    position: 'absolute', top: 0, left: 0, backgroundColor: COLORS.burgundy,
  ...
  sectionTitle: { fontFamily: THEME.fontHeading, fontSize: 25, color: THEME.textPrimary },
  ...
  bottomNavBotIcon: { width: 40, height: 40 },
});
