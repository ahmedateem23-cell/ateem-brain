...
const styles = StyleSheet.create({
  ...
  quickCatWrap: { paddingHorizontal: 20, marginTop: 20, marginBottom: 4 },
  quickCatCard: {
  ...
  quickCatDivider: { width: 1, height: 46, backgroundColor: THEME.border, alignSelf: 'center' },
  ...
  brand: { fontFamily: THEME.fontHeading, fontSize: 21, letterSpacing: 3, color: COLORS.gold },
  tagline: { fontFamily: THEME.fontBody, fontSize: 11, letterSpacing: 2, color: 'rgba(245,239,230,0.7)', marginTop: 4 },
  cartBadge: {
  ...
  hero: { paddingHorizontal: HERO_MARGIN, paddingBottom: 8, paddingTop: 26 },
  heroImageWrap: { borderRadius: 24, overflow: 'hidden' },
  ...
  sectionHeader: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 28 },
  ...
  sectionTitleUnderline: { width: 96, height: 6, borderRadius: 4, backgroundColor: COLORS.gold, marginTop: 12 },
  ...
  featuredImageWrap: {
    ...
    marginBottom: 15, position: 'relative', borderRadius: 20, overflow: 'hidden',
  },
  featuredImage: { width: '100%', height: '100%' },
  featuredHeartBtn: {
    position: 'absolute', top: 12, left: 12, width: 34, height: 34, borderRadius: 17,
    backgroundColor: 'rgba(255,255,255,0.92)', alignItems: 'center', justifyContent: 'center',
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 2,
  },
  featuredBadge: {
    position: 'absolute', top: 12, right: 12, backgroundColor: COLORS.burgundy,
  ...
  featuredTitle: {
    fontFamily: THEME.fontBodySemiBold, fontSize: 17, color: THEME.textPrimary,
    marginBottom: 7, lineHeight: 22, minHeight: 44,
  },
  featuredSubtitle: {
    fontFamily: THEME.fontBody, fontSize: 13, color: THEME.textSecondary,
    marginBottom: 10, lineHeight: 18, minHeight: 18,
  },
  featuredPrice: { fontFamily: THEME.fontBodySemiBold, fontSize: 20, color: THEME.textPrice, marginBottom: 15 },
  featuredAddBtn: {
    flexDirection: 'row', gap: 6,
    backgroundColor: COLORS.gold, borderRadius: 17, height: 58,
    alignItems: 'center', justifyContent: 'center',
  },
  ...
  featureBarWrap: { paddingHorizontal: 20, marginTop: 10, marginBottom: 12 },
  featureBar: {
    flexDirection: 'row-reverse',
  ...
  featureItemText: { fontFamily: THEME.fontBody, color: THEME.textPrimary, fontSize: 13, textAlign: 'center' },
  featureDivider: { width: 1, height: 30, backgroundColor: 'rgba(107,30,46,0.14)', alignSelf: 'center', marginTop: 6 },
  ...
  bottomNav: {
    flexDirection: 'row-reverse', height: 72, backgroundColor: THEME.card,
  ...
  bottomNavText: { fontFamily: THEME.fontBody, fontSize: 12, color: THEME.textSecondary, letterSpacing: 0.3 },
  ...
  floatingBotImage: { width: 68, height: 68 },
});
