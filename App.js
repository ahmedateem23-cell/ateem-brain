...
const GOOGLE_WEB_CLIENT_ID = 'ضع Web Client ID من Google Cloud Console هنا';
const GOOGLE_IOS_CLIENT_ID = 'ضع iOS Client ID من Google Cloud Console هنا';
const GOOGLE_ANDROID_CLIENT_ID = 'ضع Android Client ID من Google Cloud Console هنا';
...
const styles = StyleSheet.create({
  ...
  // (46px بدل 54px) بحد ذهبي رفيع جدًا وشادو ناعم خفيف — بدون أي شكل
  // روبوت/Mascot، وبدون Glow قوي. جوّاها حرف "A" بخط Playfair Display
  // بس (حرف/رمز ATEEM)، بلون عنابي.
  floatingBotAnchor: {
    position: 'absolute',
    bottom: 70,
    left: 14,
  ...
  floatingBotMark: {
    fontFamily: THEME.fontHeading, fontSize: 18, color: COLORS.burgundy, letterSpacing: 0.5,
  },
});
