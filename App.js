    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.featuredGrid, { gap: 10, marginHorizontal: -4 }]}>
            {FEATURED_PRODUCTS.map((p) => (
              <View key={p.id} style={[styles.featuredCard, { width: (width - 32 - 10) / 2 }]}>
...
const styles = StyleSheet.create({
  ...
  featuredCard: { marginBottom: 14, backgroundColor: 'transparent', borderRadius: 0, padding: 0 },
  featuredImageWrap: {
    width: '100%', aspectRatio: 1.15, backgroundColor: THEME.background,
    marginBottom: 8, position: 'relative', borderRadius: 12, overflow: 'hidden',
  },
