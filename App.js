          ...
          {LOOKS.map((look, i) => (
            <TouchableOpacity key={look.id} style={styles.lookItem}>
              <View style={{ width: '58%', height: '100%' }}>
                ...
                <View style={styles.lookImageFade} />
              </View>
...
const styles = StyleSheet.create({
  ...
  heroCtaBtnText: { fontFamily: THEME.fontBodySemiBold, color: COLORS.gold, fontSize: 14, letterSpacing: 0.5 },
  heroCtaBtnArrow: { fontFamily: THEME.fontBodySemiBold, color: COLORS.gold, fontSize: 16 },
  ...
  lookItem: {
    height: 230, marginBottom: 16, overflow: 'hidden', borderRadius: 22,
    backgroundColor: '#EFE6D8', flexDirection: 'row-reverse',
  },
  lookImage: { width: '58%', height: '100%' },
  // شبه شفاف بلون كريمي فوق الصورة عشان تتدرّج بصريًا مع لون الكارت
  // الأساسي (تقريب لتأثير التدرّج في المرجع، من غير الحاجة لمكتبة
  // linear-gradient إضافية).
  lookImageFade: {
    position: 'absolute', top: 0, bottom: 0, left: 0, width: '18%',
    backgroundColor: '#EFE6D8', opacity: 0.35,
  },
  lookOverlay: {
    flex: 1, justifyContent: 'center', alignItems: 'flex-end', paddingHorizontal: 18,
  },
  lookNumber: {
    fontFamily: THEME.fontHeading, fontSize: 42, color: 'rgba(107,30,46,0.18)', marginBottom: 6,
  },
  lookItemTitle: {
    fontFamily: THEME.fontHeading, color: COLORS.burgundy, fontSize: 21, marginBottom: 8, textAlign: 'right',
  },
