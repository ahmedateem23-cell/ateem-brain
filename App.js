...
const styles = StyleSheet.create({
  ...
  // نسخة أصغر من السعر لبطاقات "القطع الجديدة" بس (بعد ما شيلنا سطر
  // الوصف اللي كان بيسيب مساحة فاضية لما وصف المنتج مش موجود في
  // أودو) — "منتجات مميزة" فضلت بحجمها الأصلي زي ما كانت.
