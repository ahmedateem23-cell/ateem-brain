  ...
  return (
    <Modal visible={modalVisible} animationType="none" transparent onRequestClose={requestClose}>
      <Animated.View style={[cs.backdrop, { opacity: backdropOpacity }]}>
        ...
        {/* iOS: مفيش تكبير/تصغير تلقائي للنافذة، فمحتاجين padding
            يرفع المحتوى فوق الكيبورد يدويًا.
            أندرويد: النظام نفسه بيصغّر نافذة التطبيق (وضع resize
            الافتراضي) والـ backdrop بتاعنا flex:1 + justifyContent:
            'flex-end' بيثبّت البانل فوق الكيبورد تلقائيًا من غير أي
            تدخل إضافي — وبما إن ارتفاع البانل بقى رقم ثابت (PANEL_HEIGHT)
            مش نسبة، الحجم بيفضل زي ما هو بالظبط. إضافة behavior هنا
            كانت بتعمل تعويض مزدوج مع تصغير النظام نفسه، وده اللي كان
            بيخلي الشات "يتقلّص" أكتر بدل ما يرتفع. */}
        <KeyboardAvoidingView
