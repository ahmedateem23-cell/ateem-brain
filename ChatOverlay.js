...
// شريط الإجراءات السريعة الثابت أسفل الشات (يطابق شريط الأيقونات
// الثلاث في التصميم المرجعي: عروض حصرية / سياسة التوصيل / تتبع الطلب).
const UTILITY_ACTIONS = [
  { icon: 'mail-outline', label: 'عروض حصرية', text: 'أعرض لي العروض الحصرية' },
  { icon: 'car-outline', label: 'سياسة التوصيل', text: 'ما هي سياسة التوصيل؟' },
  { icon: 'cube-outline', label: 'تتبع طلبك', text: 'أريد تتبع طلبي' },
];
          ...
          <View style={cs.panel}>
            ...
            <View style={cs.header}>
              <View style={cs.headerContent}>
                ...
                <View>
                  <Text style={cs.title}>بوت ATEEM</Text>
            ...
            <View style={cs.footerBrand}>
              <Text style={cs.footerBrandText}>ATEEM  ·  SUDAN  ·  MODERN LUXURY</Text>
            </View>
          </View>
        </KeyboardAvoidingView>
      </View>
...
const cs = StyleSheet.create({
  ...
  headerContent: { flexDirection: 'row-reverse', alignItems: 'center', gap: 9 },
  logoImgWrap: {
  ...
  userWrap: { alignItems: 'flex-end', maxWidth: '82%', alignSelf: 'flex-end' },
  userBubble: {
  ...
  // صف رسالة البوت: أفاتار صغير ثابت في أقصى اليسار ثم فقاعة الرد،
  // بترتيب 'row' صريح (مش row-reverse) عشان الأفاتار يفضل شمال
  // البابل زي التصميم المرجعي بغض النظر عن إعداد RTL للجهاز.
  botRow: { flexDirection: 'row', alignItems: 'flex-start', maxWidth: '90%', alignSelf: 'flex-start', gap: 8 },
  msgAvatar: { width: 26, height: 26, borderRadius: 13, marginTop: 2 },
  botCol: { flex: 1 },
  botBubble: {
  ...
  timeBot: { fontFamily: THEME.fontBody, fontSize: 9.5, color: THEME.textSecondary, marginTop: 3, paddingHorizontal: 2, textAlign: 'right' },

  errorBubble: {
    backgroundColor: '#FBEAEA', borderWidth: 1, borderColor: '#E8B7B7',
    borderRadius: 14, padding: 12, flex: 1,
  },
  ...
  // بطاقات المنتجات: شبكة أفقية من 3 أعمدة تحت فقاعة الرد، بصورة تملأ
  // عرض البطاقة، اسم ثم سعر + زر إضافة دائري صغير — مطابقة لعرض
  // الاقتراحات في التصميم المرجعي.
  productsWrap: { flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8, marginTop: 8 },
  productCard: {
    width: '31.5%',
    backgroundColor: THEME.card, borderWidth: 1, borderColor: THEME.border,
    borderRadius: 12, overflow: 'hidden', paddingBottom: 7,
  },
  productCardImgWrap: { width: '100%', aspectRatio: 1, backgroundColor: THEME.background },
  productCardName: {
    fontFamily: THEME.fontBody, fontSize: 10.5, color: THEME.textPrimary,
    textAlign: 'center', marginTop: 6, paddingHorizontal: 4,
  },
  productCardBottomRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    marginTop: 5, paddingHorizontal: 6,
  },
  productCardPrice: { fontFamily: THEME.fontBodySemiBold, fontSize: 9.5, color: THEME.textPrice, flex: 1 },
  productCardAddBtn: {
    width: 20, height: 20, borderRadius: 10, backgroundColor: COLORS.gold,
    alignItems: 'center', justifyContent: 'center',
  },
  ...
  utilityBar: {
    flexDirection: 'row', gap: 8, paddingHorizontal: 12, paddingTop: 8, paddingBottom: 2,
    backgroundColor: THEME.background,
  },
  utilityChip: {
    flex: 1, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 5,
    borderWidth: 1, borderColor: COLORS.gold, borderRadius: 18,
  ...
  input: {
    flex: 1, backgroundColor: THEME.card, borderWidth: 1, borderColor: THEME.border, borderRadius: 19,
  ...
  sendBtn: {
    width: 34, height: 34, borderRadius: 17, backgroundColor: COLORS.burgundy,
    alignItems: 'center', justifyContent: 'center',
  },

  footerBrand: { paddingVertical: 8, alignItems: 'center', backgroundColor: THEME.background },
  footerBrandText: { fontFamily: THEME.fontBody, fontSize: 9, color: COLORS.gold, letterSpacing: 1 },
});
