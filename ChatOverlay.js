...
const cs = StyleSheet.create({
  ...
  // بطاقات المنتجات: صف أفقي قابل للسحب (مش شبكة تلف لسطر تاني) — 3
  // بطاقات تقريبًا ظاهرة جوه إطار الشات، وأي بطاقات زيادة بتتسحب
  // باليد. مقاسات أكبر ومتوازنة، وألوان أدفأ من كارت الرسائل العادي
  // عشان تبرز كعناصر قابلة للنقر لوحدها.
  ...
  input: {
    flex: 1, backgroundColor: THEME.card, borderWidth: 1, borderColor: THEME.border, borderRadius: 20,
