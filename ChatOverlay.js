...
const cs = StyleSheet.create({
  ...
  // بالأيقونات القديمة.
  // flex:1 على الثلاثة بيخليهم بعرض متساوي بالظبط في صف واحد بدل ما
  // يتلفوا بأحجام مختلفة حسب طول النص — "عروض حصرية" و"تتبع طلبك"
  // و"سياسة التوصيل" بقوا بنفس العرض تمامًا.
  optionsWrap: { flexDirection: 'row-reverse', gap: 8, marginTop: 10 },
  optionPill: {
    flex: 1,
    alignItems: 'center', justifyContent: 'center',
