...
const cs = StyleSheet.create({
  ...
  logoImgWrap: {
    ...
    // ظل خفيف يفصل الدائرة بصريًا عن خلفية الهيدر العنابي، فوق التباين
    // اللوني نفسه (خلفية فاتحة + برواز ذهبي) — بيديها إحساس إنها "طافية"
    // فوق الهيدر مش مندمجة فيه.
    shadowColor: '#000',
  ...
  // مقاس الصورة أصغر شوية من الدائرة نفسها (46 جوه 50) عشان يفضل فيه
  // إطار من الخلفية الفاتحة حوالين الشعار — نفس مبدأ "هامش الأمان"
  // المطلوب لأيقونة التطبيق وشاشة البدء، لكن مطبّق هنا على شعار الشات.
  logoImg: {
