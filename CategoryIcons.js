...
export function ShoesIcon({ size = 24, color = DEFAULT_COLOR }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 64 64" fill="none">
      {/* حذاء كلاسيكي أنيق (Oxford) بدل شكل السنيكرز السابق — بروفايل
          أرشق ومناسب أكتر لهوية براند فخامة. */}
      <Path
        d="M9 43 C9 37 10 31 16 28 C20 26 25 25.5 29 27 L40 31 C46 33.5 52 33 56 30 C58.5 28 60 30 59.5 33 C58.5 38 53 41.5 46 42 L9 43 Z"
        stroke={color} strokeWidth={STROKE} strokeLinecap="round" strokeLinejoin="round"
      />
      <Path
        d="M15 29 C15 32.5 15 36 15 39.5"
        stroke={color} strokeWidth={STROKE - 0.5} strokeLinecap="round" strokeLinejoin="round"
      />
      <Path
        d="M30 29 L34 26 M34 32 L38 29"
        stroke={color} strokeWidth={STROKE - 0.5} strokeLinecap="round" strokeLinejoin="round"
      />
    </Svg>
  );
